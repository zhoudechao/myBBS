...
<head>
	<meta charset="utf-8">
	<title>个人资料--OneManage后台管理模板</title>
...
<body class="childrenBody">
	...
	<script type="text/javascript" src="${path}/res/js/one-js/address.js"></script>
	<script type="text/javascript" src="${path}/res/js/one-js/userInfo.js"></script>
